...
echo "🔧 ClearML OpenShift SSL Bypass - Starting comprehensive SSL setup..."
...
print("✅ SSL verification bypassed globally at Python SSL context level")
PYTHON_EOF

# Execute SSL bypass setup BEFORE starting ClearML
python3 /tmp/ssl_bypass_init.py

echo "✅ SSL bypass setup completed!"
echo "🚀 Starting ClearML API Server with SSL bypass..."
